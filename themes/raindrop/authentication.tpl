            ...
            <form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="create-account_form" class="box">
                <div class="form_content clearfix">
                    ...
                    <div class="submit">
                        ...
                        <button class="btn btn-primary exclusive no-border-radius" type="submit" id="SubmitCreate" name="SubmitCreate">
                            <span>
        ...
        <div class="frame_wrap frame_wrap_content">
            <form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
                <div class="form_content clearfix">
                    ...
                    <p class="submit">
                        {if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'html':'UTF-8'}" />{/if}
                        <button type="submit" id="SubmitLogin" name="SubmitLogin" class="button btn no-border-radius">
                            <span>
...
{if isset($inOrderProcess) && $inOrderProcess && $PS_GUEST_CHECKOUT_ENABLED}
    ...
    <div class="frame_wrap frame_wrap_content clearfix">
        <form action="{$link->getPageLink('authentication', true, NULL, "back=$back")|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std form-horizontal clearfix" role="form">
            <div class="box">
                <div id="opc_account_form" style="display: block; ">
                    <!-- Account -->
                    <div class="required form-group">
                        <label for="guest_email" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Email address'} <sup>*</sup></label>
                    ...
                    <div class="form-group gender-line clearfix">
                        <label class="control-label col-lg-4 col-md-4 col-sm-4">{l s='Title'}</label>
                        <div class="col-lg-5 col-md-5 col-sm-5">
                    ...
                    <div class="required form-group">
                        <label for="firstname" class="control-label col-lg-4 col-md-4 col-sm-4 col-sm-4">{l s='First name'} <sup>*</sup></label>
                        <div class="col-lg-5 col-md-5 col-sm-5">
                    ...
                    <div class="required form-group">
                        <label for="lastname" class="control-label col-lg-4 col-md-4 col-sm-4 col-sm-4">{l s='Last name'} <sup>*</sup></label>
                        <div class="col-lg-5 col-md-5 col-sm-5">
                    ...
                    <div class="form-group date-select">
                        <label class="control-label col-lg-4 col-md-4 col-sm-4 col-sm-4">{l s='Date of Birth'}</label>
                        <div <div class="row col-lg-5 col-md-5 col-sm-5">
                            <div class="col-xs-4">
                    ...
                    {if isset($newsletter) && $newsletter}
                        <div class="form-group">
                            <div class="col-lg-3 col-md-4 col-sm-6 col-lg-offset-3 col-md-offset-3 col-sm-offset-3">
                                <input type="checkbox" name="newsletter" id="newsletter" value="1" {if isset($smarty.post.newsletter) && $smarty.post.newsletter == '1'}checked="checked"{/if} />
                                <label for="newsletter">{l s='Sign up for our newsletter!'}</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-lg-4 col-md-5 col-sm-7 col-lg-offset-3 col-md-offset-3 col-sm-offset-3">
                    ...
                    {foreach from=$dlv_all_fields item=field_name}
                        {if $field_name eq "company" && $b2b_enable}
                            <div class="form-group">
                                <label for="company" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='Company'}</label>
                                <div class="col-lg-5 col-md-5 col-sm-5">
                        ...
                        {elseif $field_name eq "vat_number"}
                            <div id="vat_number" style="display:none;">
                                <div class="form-group">
                                    <label for="vat-number" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='VAT number'}</label>
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                        ...
                        {elseif $field_name eq "dni"}
                            ...
                            <div class="required dni form-group">
                                <label for="dni" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='Identification number'} <sup>*</sup></label>
                                <div class="col-lg-5 col-md-5 col-sm-5">
                        ...
                        {elseif $field_name eq "address1"}
                            <div class="required form-group">
                                <label for="address1" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='Address'} <sup>*</sup></label>
                                <div class="col-lg-5 col-md-5 col-sm-5">
                        ...
                        {elseif $field_name eq "address2"}
                            <div class="form-group is_customer_param">
                                <label for="address2" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='Address (Line 2)'} <sup>*</sup></label>
                                <div class="col-lg-5 col-md-5 col-sm-5">
                        ...
                        {elseif $field_name eq "postcode"}
                            ...
                            <div class="required postcode form-group">
                                <label for="postcode" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='Zip/Postal Code'} <sup>*</sup></label>
                                <div class="col-lg-5 col-md-5 col-sm-5">
                        ...
                        {elseif $field_name eq "city"}
                            <div class="required form-group">
                                <label for="city" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='City'} <sup>*</sup></label>
                                <div class="col-lg-5 col-md-5 col-sm-5">
                        ...
                        {elseif $field_name eq "Country:name" || $field_name eq "country"}
                            <div class="required select form-group">
                                <label for="id_country" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='Country'} <sup>*</sup></label>
                                <div class="col-lg-5 col-md-5 col-sm-5">
                        ...
                        {elseif $field_name eq "State:name"}
                            ...
                            <div class="required id_state select form-group">
                                <label for="id_state" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='State'} <sup>*</sup></label>
                                <div class="col-lg-5 col-md-5 col-sm-5">
                    ...
                    <div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
                        <label for="phone_mobile" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='Mobile phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>*</sup>{/if}</label>
                        <div class="col-lg-5 col-md-5 col-sm-5">
                    ...
                    <div id="opc_invoice_address"  class="unvisible">
                        ...
                        {foreach from=$inv_all_fields item=field_name}
                            {if $field_name eq "company" && $b2b_enable}
                                <div class="form-group">
                                    <label for="company_invoice" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='Company'}</label>
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                            ...
                            {elseif $field_name eq "vat_number"}
                                <div id="vat_number_block_invoice" class="is_customer_param" style="display:none;">
                                    <div class="form-group">
                                        <label for="vat_number_invoice" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='VAT number'}</label>
                                        <div class="col-lg-5 col-md-5 col-sm-5">
                            ...
                            {elseif $field_name eq "firstname"}
                                <div class="required form-group">
                                    <label for="firstname_invoice" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='First name'} <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                            ...
                            {elseif $field_name eq "lastname"}
                                <div class="required form-group">
                                    <label for="lastname_invoice" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='Last name'} <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                            ...
                            {elseif $field_name eq "address1"}
                                <div class="required form-group">
                                    <label for="address1_invoice" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='Address'} <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                            ...
                            {elseif $field_name eq "address2"}
                                <div class="form-group is_customer_param">
                                    <label for="address2_invoice" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='Address (Line 2)'}</label>
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                            ...
                            {elseif $field_name eq "postcode"}
                                ...
                                <div class="required postcode_invoice form-group">
                                    <label for="postcode_invoice" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='Zip/Postal Code'} <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                            ...
                            {elseif $field_name eq "city"}
                                <div class="required form-group">
                                    <label for="city_invoice" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='City'} <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                            ...
                            {elseif $field_name eq "country" || $field_name eq "Country:name"}
                                <div class="required form-group">
                                    <label for="id_country_invoice" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='Country'} <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                            ...
                            {elseif $field_name eq "state" || $field_name eq 'State:name'}
                                ...
                                <div class="required id_state_invoice form-group" style="display:none;">
                                    <label for="id_state_invoice" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='State'} <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                        ...
                        {/if}
                        <div class="form-group is_customer_param">
                            <label for="other_invoice" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='Additional information'}</label>
                            <div class="col-lg-5 col-md-5 col-sm-5">
                                <textarea class="form-control" name="other_invoice" id="other_invoice" cols="26" rows="3"></textarea>
                            </div>
                        </div>
                        <div class="form-group is_customer_param">
                            <label for="phone_invoice" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='Home phone'}</label>
                            <div class="col-lg-5 col-md-5 col-sm-5">
                        ...
                        <div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
                            <label for="phone_mobile_invoice" class="control-label col-lg-4 col-md-4 col-sm-4">{l s='Mobile phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>*</sup>{/if}</label>
                            <div class="col-lg-5 col-md-5 col-sm-5">
            ...
            <p class="cart_navigation required submit clearfix">
                ...
                <button type="submit" class="button btn btn-lg btn-primary exclusive standard-checkout no-border-radius" name="submitGuestAccount" id="submitGuestAccount">
                    <span>
...
{else}
    ...
    {/if}-->
        ...
        <div class="frame_wrap frame_wrap_content clearfix">
            <form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std box form-horizontal" role="form">
                {$HOOK_CREATE_ACCOUNT_TOP}
                <div class="account_creation">
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Title'}</label>
                        <div class="col-lg-5 col-md-5 col-sm-5">
                        {foreach from=$genders key=k item=gender}
                            <div class="radio-inline">
                                <label for="id_gender{$gender->id}" class="top">
                    ...
                    <div class="required form-group">
                        <label for="customer_firstname" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='First name'} <sup>*</sup></label>
                        <div class="col-lg-5 col-md-5 col-sm-5">
                    ...
                    <div class="required form-group">
                        <label for="customer_lastname" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Last name'} <sup>*</sup></label>
                        <div class="col-lg-5 col-md-5 col-sm-5">
                    ...
                    <div class="required form-group">
                        <label for="email" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Email'} <sup>*</sup></label>
                        <div class="col-lg-5 col-md-5 col-sm-5">
                    ...
                    <div class="required password form-group">
                        <label for="passwd" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Password'} <sup>*</sup></label>
                        <div class="col-lg-5 col-md-5 col-sm-5">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Date of Birth'}</label>
                        <div class="col-lg-5 col-md-5 col-sm-5 col-md-5 row">
                            <div class="col-xs-3">
                                <select id="days" name="days" class="form-control">
                                    <option value="">-</option>
                                    {foreach from=$days item=day}
                ...
                {if $b2b_enable}
                    <div class="account_creation">
                        ...
                        <div class="form-group">
                            <label for="company" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Company'}</label>
                            <div class="col-lg-5 col-md-5 col-sm-5">
                                <input type="text" class="form-control" id="company" name="company" value="{if isset($smarty.post.company)}{$smarty.post.company}{/if}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="siret" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='SIRET'}</label>
                            <div class="col-lg-5 col-md-5 col-sm-5">
                                <input type="text" class="form-control" id="siret" name="siret" value="{if isset($smarty.post.siret)}{$smarty.post.siret}{/if}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="ape" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='APE'}</label>
                            <div class="col-lg-5 col-md-5 col-sm-5">
                                <input type="text" class="form-control" id="ape" name="ape" value="{if isset($smarty.post.ape)}{$smarty.post.ape}{/if}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="website" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Website'}</label>
                            <div class="col-lg-5 col-md-5 col-sm-5">
                ...
                {if isset($PS_REGISTRATION_PROCESS_TYPE) && $PS_REGISTRATION_PROCESS_TYPE}
                    <div class="account_creation">
                        ...
                        {foreach from=$dlv_all_fields item=field_name}
                            ...
                            {elseif $field_name eq "vat_number"}
                                <div id="vat_number" style="display:none;">
                                    <div class="form-group">
                                        <label for="vat_number" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='VAT number'}</label>
                                        <div class="col-lg-5 col-md-5 col-sm-5">
                            ...
                            {elseif $field_name eq "firstname"}
                                <div class="required form-group">
                                    <label for="firstname" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='First name'} <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                            ...
                            {elseif $field_name eq "lastname"}
                                <div class="required form-group">
                                    <label for="lastname" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Last name'} <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                            ...
                            {elseif $field_name eq "address1"}
                                <div class="required form-group">
                                    <label for="address1" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Address'} <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                                        <input type="text" class="form-control" name="address1" id="address1" value="{if isset($smarty.post.address1)}{$smarty.post.address1}{/if}" />
                            ...
                            {elseif $field_name eq "address2"}
                                <div class="form-group is_customer_param">
                                    <label for="address2" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Address (Line 2)'}</label>
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                                        <input type="text" class="form-control" name="address2" id="address2" value="{if isset($smarty.post.address2)}{$smarty.post.address2}{/if}" />
                            ...
                            {elseif $field_name eq "postcode"}
                                {assign var='postCodeExist' value=true}
                                <div class="required postcode form-group">
                                    <label for="postcode" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Zip/Postal Code'} <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                            ...
                            {elseif $field_name eq "city"}
                                <div class="required form-group">
                                    <label for="city" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='City'} <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                                        <input type="text" class="form-control" name="city" id="city" value="{if isset($smarty.post.city)}{$smarty.post.city}{/if}" />
                                    </div>
                                </div>
                            ...
                            {elseif $field_name eq "Country:name" || $field_name eq "country"}
                                <div class="required select form-group">
                                    <label for="id_country" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Country'} <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                                        <select name="id_country" id="id_country" class="form-control">
                                            <option value="">-</option>
                                            {foreach from=$countries item=v}
                            ...
                            {elseif $field_name eq "State:name" || $field_name eq 'state'}
                                {assign var='stateExist' value=true}
                                <div class="required id_state select form-group">
                                    <label for="id_state" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='State'} <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                                        <select name="id_state" id="id_state" class="form-control">
                                            <option value="">-</option>
                                        </select>
                        ...
                        <div class="textarea form-group">
                            <label for="other" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Additional information'}</label>
                            <div class="col-lg-5 col-md-5 col-sm-5">
                                <textarea class="form-control" name="other" id="other" cols="26" rows="3">{if isset($smarty.post.other)}{$smarty.post.other}{/if}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="phone" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Home phone'}</label>
                            <div class="col-lg-5 col-md-5 col-sm-5">
                                <input type="text" class="form-control" name="phone" id="phone" value="{if isset($smarty.post.phone)}{$smarty.post.phone}{/if}" />
                            </div>
                        </div>
                        <div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
                            <label for="phone_mobile" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Mobile phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>*</sup>{/if}</label>
                            <div class="col-lg-5 col-md-5 col-sm-5">
                                <input type="text" class="form-control" name="phone_mobile" id="phone_mobile" value="{if isset($smarty.post.phone_mobile)}{$smarty.post.phone_mobile}{/if}" />
                                <p class="help-block">{l s='You must register at least one phone number.'}</p>
                            </div>
                        </div>
                        <div class="required form-group" id="address_alias">
                            <label for="alias" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Assign an address alias for future reference.'} <sup>*</sup></label>
                            <div class="col-lg-5 col-md-5 col-sm-5">
                    ...
                    <div class="account_creation dni">
                        ...
                        <div class="required form-group">
                            <label for="dni" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Identification number'} <sup>*</sup></label>
                            <div class="col-lg-5 col-md-5 col-sm-5">
                ...
                <div class="submit form-group">
                    ...
                    {if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'html':'UTF-8'}" />{/if}
                    <button type="submit" name="submitAccount" id="submitAccount" class="btn btn-primary no-border-radius exclusive">
