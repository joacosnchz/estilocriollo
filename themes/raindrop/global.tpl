...
{if isset($pageLoader)}
    {addJsDef pageLoader=$pageLoader|boolval}
{/if}
{if isset($fadeInScroll)}
    {addJsDef fadeInScroll=$fadeInScroll|boolval}
{/if}
{if isset($navSecondaryFixed)}
    {addJsDef navSecondaryFixed=$navSecondaryFixed|boolval}
{/if}
{if isset($vertical_menu_fixed)}
    {addJsDef vertical_menu_fixed=$vertical_menu_fixed|boolval}
{/if}
{if isset($plProductDisplay)}
    {addJsDef plProductDisplay=$plProductDisplay}
{/if}
{/strip}