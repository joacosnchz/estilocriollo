...
<div class="frame_wrap frame_wrap_content clearfix">
    <div id="carrier_area">
        ...
        <form id="form" action="{$link->getPageLink('order', true, NULL, "multi-shipping={$multi_shipping}")|escape:'html':'UTF-8'}" method="post" name="carrier_area" class="form-horizontal" role="form">
        {else}
            <div id="carrier_area" class="opc-main-block">
                <div class="frame_wrap frame_wrap_header clearfix">
                    <div class="fwh-title"><span class="opc_enum">2</span> {l s='Delivery methods'}</div>
                </div>
                <div class="frame_wrap frame_wrap_content clearfix">
                    ...
                    <div class="order_carrier_content box">
                        ...
                        {else}
                            ...
                            {if $giftAllowed}
                                ...
                                <div id="gift_div" class="form-group clearfix">
                                    <div class="col-xs-12">
                    ...
                    {if $conditions AND $cms_id}
                        ...
                        <div class="form-group clearfix">
                            <div class="col-xs-12">
                                ...
                                <label for="cgv">{l s='I agree to the terms of service and will adhere to them unconditionally. '}<a href="{$link_conditions|escape:'html':'UTF-8'}" class="iframe" rel="nofollow">{l s='(Read the Terms of Service)'}</a></label>
                            </div>
                        </div>
                    {/if}
                </div> <!-- end delivery_options_address -->
                {if !$opc}
                    <p class="cart_navigation clearfix">
                        ...
                        {if !$is_guest}
                            {if $back}
                                <a 
                                    ...
                                    title="{l s='Previous'}"
                                    class="button-exclusive btn button btn-default no-border-radius">
                        ...
                        {if isset($virtual_cart) && $virtual_cart || (isset($delivery_option_list) && !empty($delivery_option_list))}
                            <button type="submit" name="processCarrier" class="btn btn-primary exclusive standard-checkout no-border-radius">
                                <span>
