...
<div class="frame_wrap frame_wrap_content clearfix">
                    ...
                    {foreach from=$orders item=order name=myLoop}
                        <tr class="{if $smarty.foreach.myLoop.first}first_item{elseif $smarty.foreach.myLoop.last}last_item{else}item{/if} {if $smarty.foreach.myLoop.index % 2}alternate_item{/if}">
                            ...
                            <td class="history_detail">
                                <a class="btn button no-border-radius" href="javascript:showOrder(1, {$order.id_order|intval}, '{$link->getPageLink('order-detail', true)|escape:'html':'UTF-8'}');">
                                    <span>
                                        {l s='Details'}</i>
                                    </span>
                                </a>
    ...
    <ul class="footer_links clearfix">
        <li>
            <a class="btn button no-border-radius" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}">
                <span>
