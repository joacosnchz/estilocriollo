        ...
        {if isset($transformSuccess)}
            ...
            <form method="post" action="{$action|escape:'html':'UTF-8'}#guestToCustomer" class="std">
                <fieldset class="description_box box">
                    ...
                    <p>
                        <button type="submit" name="submitTransformGuestToCustomer" class="btn btn-primary exclusive no-border-radius"><span>{l s='Send'}</span></button>
                    </p>
                </fieldset>
            </form>
        {/if}
    {else}
        ...
        <form method="post" action="{$action|escape:'html':'UTF-8'}" class="std" id="guestTracking">
            <fieldset class="description_box box">
                ...
                <p>
                    <button type="submit" name="submitGuestTracking" class="btn btn-primary exclusive no-border-radius"><span>{l s='Send'}</span></button>
                </p>
            </fieldset>
        </form>
    {/if}
