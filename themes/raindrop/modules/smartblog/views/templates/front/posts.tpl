...
<div id="content" class="block">
    <div itemtype="#" itemscope="" id="sdsblogArticle" class="blog-post">
        <div class="page-item-title frame_wrap frame_wrap_header clearfix">
            <div class="fwh-title">{$meta_title}</div>
        </div>
        <div itemprop="articleBody" class="frame_wrap frame_wrap_content clearfix">
        ...
        <div class="smartblogcomments" id="respond">
            ...
            <div id="commentInput">
                ...
                <div class="right">
                    ...
                    <div class="submit">
                        <input type="submit" name="addComment" id="submitComment" class="button btn exclusive" value="Submit">
                    </div>
