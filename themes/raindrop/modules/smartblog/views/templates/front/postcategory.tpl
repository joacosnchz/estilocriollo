	...
	{if $smartdisablecatimg == '1'}
        ...
        {if $title_category != ''}        
           {foreach from=$categoryinfo item=category}
            <div id="sdsblogCategory" class="frame_wrap">
...
{*                   <img alt="{$category.meta_title}" src="{$modules_dir}/smartblog/images/category/{$cat_image}-home-default.jpg" class="imageFeatured">*}
                   <img alt="{$category.meta_title}" src="{$modules_dir}/smartblog/images/category/{$cat_image}-raindrop-category.jpg" class="imageFeatured">
               {/if}
