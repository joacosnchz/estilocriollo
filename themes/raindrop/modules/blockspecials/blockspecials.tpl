...
<div id="special_block_right" class="block">
    <div class="frame_wrap frame_wrap_header clearfix">
        <div class="fwh-title"><a href="{$link->getPageLink('prices-drop')|escape:'html':'UTF-8'}" title="{l s='Specials' mod='blockspecials'}">{l s='Specials' mod='blockspecials'}</a></div>
    </div>
                ...
                <li class="clearfix">
                    <a class="products-block-image" href="{$special.link|escape:'html':'UTF-8'}">
                        <img 
                            ...
                            src="{$link->getImageLink($special.link_rewrite, $special.id_image, 'medium')|escape:'html':'UTF-8'}" 
