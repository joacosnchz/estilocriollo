    ...
    {if $page_name == 'product'}
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                <div id="crossselling_prev"></div>
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#productFooter" href="#crossSellingBlock">
                        {l s='Customers who bought this product also bought' mod='crossselling'}
                    </a>
                </h4>
                <div id="crossselling_next"></div>
            </div>
            <div id="crossSellingBlock" class="panel-collapse collapse">
                <div class="panel-body">
                    <ul class="bxslider clearfix" data-prev="#crossselling_prev" data-next="#crossselling_next">
                            ...
                            <li class="product-box item">
                                ...
                                <p itemprop="name" class="product_name">
                                    <a itemprop="url" href="{$orderProduct.link|escape:'html':'UTF-8'}" title="{$orderProduct.name|htmlspecialchars}">
                                        {$orderProduct.name|truncate:20:'...'|escape:'html':'UTF-8'}
                                    </a>
                                </p>
