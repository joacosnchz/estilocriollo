            ...
            <div class="cart_block block exclusive">
                <div class="block_content">
                    ...
                    <p class="cart-buttons">
                        <a id="button_order_cart" class="btn btn-primary exclusive no-border-radius" href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Check out' mod='blockcart'}" rel="nofollow">
                            <span>
    ...
    <div id="layer_cart">
        <div class="visible-xs">
            <div class="frame_wrap frame_wrap_header clearfix">
                <div class="fwh-title">{l s='Added to cart' mod='blockcart'}</div>
                <div class="frame_secondary"><span class="cross" title="{l s='Close window' mod='blockcart'}"></span></div>
            </div>
            <div class="frame_wrap frame_wrap_content clearfix">
                <a class="btn btn-primary exclusive no-border-radius" href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Proceed to checkout' mod='blockcart'}" rel="nofollow">
                    <span>{l s='Proceed to checkout' mod='blockcart'}</span>
                </a>	
                <span class="continue btn btn-default no-border-radius mobile_btn" title="{l s='Continue shopping' mod='blockcart'}">
        ...
        <div class="clearfix hidden-xs">
            <div class="frame_wrap frame_wrap_header clearfix">
                <div class="fwh-title">{l s='Product successfully added to your shopping cart' mod='blockcart'}</div>
                <div class="frame_secondary"><span class="cross" title="{l s='Close window' mod='blockcart'}"></span></div>
            </div>
            <div class="frame_wrap frame_wrap_content clearfix">
                <div class="col-xs-3">
                ...
                <div class="col-xs-9">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <strong class="ajax_cart_product_txt_s {if $cart_qties < 2} unvisible{/if}">
                            ...
                            <strong class="ajax_cart_product_txt {if $cart_qties > 1} unvisible{/if}">
                        ...
                        <div class="panel-footer">
                            ...
                            <span class="continue btn btn-default no-border-radius" title="{l s='Continue shopping' mod='blockcart'}">
                                <span>{l s='Continue shopping' mod='blockcart'}</span>
                            </span>
                        </div>
                    </div>
