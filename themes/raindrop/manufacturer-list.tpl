...
<div class="frame_wrap frame_wrap_header clearfix">
    <div class="fwh-title">{l s='Brands'}</div>
                ...
                <div class="row"> 
                    <div class="left-side col-xs-12 col-sm-3">
                        <div class="logo">
                            {if $manufacturer.nb_products > 0}
                                ...
                                {/if}
                                <img src="{$img_manu_dir}{$manufacturer.image|escape:'html':'UTF-8'}-small_raindrop.jpg" alt="" />
                                {if $manufacturer.nb_products > 0}
                                </a>
                            {/if}
                        </div> <!-- .logo -->
                    ...
                    <div class="right-side col-xs-12 col-sm-4">
                        <div class="right-side-content">
                            ...
                            {if $manufacturer.nb_products > 0}
                                <a 
                                    class="btn btn-default btn-primary exclusive no-border-radius" 
                                    href="{$link->getmanufacturerLink($manufacturer.id_manufacturer, $manufacturer.link_rewrite)|escape:'html':'UTF-8'}">
                                    <span>
                                        {l s='view products'}
                                    </span>
