...
<div class="box">
    ...
    <form action="{$link->getPageLink('address', true)|escape:'html':'UTF-8'}" method="post" class="std form-horizontal" role="form" id="add_address">
        ...
        {foreach from=$ordered_adr_fields item=field_name}
            ...
            {if $field_name eq 'vat_number'}
                <div id="vat_area">
                    <div id="vat_number">
                        <div class="form-group">
                            <label for="vat-number" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='VAT number'}</label>
                            <div class="col-lg-5 col-md-5 col-sm-5">
            ...
            {if $field_name eq 'dni'}
                ...
                <div class="required form-group">
                    <label for="dni" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Identification number'}</label>
                    <div class="col-lg-5 col-md-5 col-sm-5">
            ...
            {if $field_name eq 'phone'}
                ...
                <div class="form-group phone-number">
                    <label for="phone" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Home phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>**</sup>{/if}</label>
                    <div class="col-lg-5 col-md-5 col-sm-5">
                        ...
                        {if isset($one_phone_at_least) && $one_phone_at_least}
                            ...
                            <span class="help-block">** {l s='You must register at least one phone number.'}</span>
                        {/if}
                    </div>
                </div>
            {/if}
        ...
        <div class="required form-group" id="adress_alias">
            <label for="alias" class="col-lg-4 col-md-4 col-sm-4 control-label">{l s='Assign an address title for future reference.'} <sup>*</sup></label>
            <div class="col-lg-5 col-md-5 col-sm-5">
        ...
        <p class="submit2">
            ...
            <button type="submit" name="submitAddress" id="submitAddress" class="btn btn-primary exclusive no-border-radius">
                <span>
                    {l s='Save'}
                </span>
            </button>
...
<ul class="footer_links clearfix">
    <li>
        <a class="btn button no-border-radius" href="{$link->getPageLink('addresses', true)|escape:'html':'UTF-8'}">
