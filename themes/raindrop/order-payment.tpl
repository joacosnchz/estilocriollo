...
{else}
    <div id="opc_payment_methods" class="opc-main-block col-xs-12 col-sm-12">
        <div class="frame_wrap frame_wrap_header clearfix">
            <div class="fwh-title"><span class="opc_enum">3</span> {l s='Please choose your payment method'}</div>
        </div>
        <div class="frame_wrap frame_wrap_content clearfix">
...
{if !$opc}
    <p class="cart_navigation clearfix">
        <a href="{$link->getPageLink('order', true, NULL, "step=2")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="button-exclusive btn button no-border-radius">
