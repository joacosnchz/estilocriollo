                            ...
                            <div class="clearfix">
                                <div class="button-container">
                                    {if (!$product->hasAttributes() OR (isset($add_prod_display) AND ($add_prod_display == 1))) AND $product->minimal_quantity == 1 AND $product->customizable != 2 AND !$PS_CATALOG_MODE}
                                        ...
                                        {else}
                                            <span class="ajax_add_to_cart_button btn btn-primary exclusive no-border-radius disabled">
                                                <span>{l s='Add to cart'}</span>
                                            </span>
                                        {/if}
                                    {/if}
...
<ul class="footer_link">
    <li>
        <a class="button lnk_view btn btn-default no-border-radius" href="{$base_dir}">
