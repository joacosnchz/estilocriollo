...
<div class="box box-small clearfix">
        <form id="submitReorder" action="{if isset($opc) && $opc}{$link->getPageLink('order-opc', true)}{else}{$link->getPageLink('order', true)}{/if}" method="post" class="submit">
            ...
            <a href="#" onclick="$(this).closest('form').submit();
                    return false;" class="button btn no-border-radius pull-right"><span>{l s='Reorder'}</span></a>
            <p class="dark">
...
{if !$is_guest}<form action="{$link->getPageLink('order-follow', true)|escape:'html':'UTF-8'}" method="post">{/if}
                            ...
                            <tr class="item">
                                ...
                                <td>
                                    ...
                                    <div class="clearfix return_quantity_buttons">
                                        ...
                                        <a href="#" class="return_quantity_up btn btn-default button-plus no-border-radius"><span><i class="icon-plus"></i></span></a>
                                    </div>                        
                                ...
                                {foreach $customizationPerAddress as $customizationId => $customization}
                                    <tr class="alternate_item">
                                        ...
                                        <td>
                                            ...
                                            <div class="clearfix return_quantity_buttons">
                                                <a href="#" class="return_quantity_down btn btn-default button-minus no-border-radius"><span><i class="icon-minus"></i></span></a>
                                                <a href="#" class="return_quantity_up btn btn-default button-plus no-border-radius"><span><i class="icon-plus"></i></span></a>
                                            </div>
    ...
    {if $return_allowed}
        <div id="returnOrderMessage">
            ...
            <p class="form-group">
                <button type="submit" name="submitReturnMerchandise" class="btn button button-small"><span>{l s='Make an RMA slip'}<i class="icon-chevron-right right"></i></span></button>
...
{if !$is_guest}
    ...
    <form action="{$link->getPageLink('order-detail', true)|escape:'html':'UTF-8'}" method="post" class="std" id="sendOrderMessage">
        ...
        <div class="submit">
            ...
            <button type="submit" name="submitMessage" class="button btn no-border-radius"><span>{l s='Send'}</span></button>
        </div>
    </form>
{else}
