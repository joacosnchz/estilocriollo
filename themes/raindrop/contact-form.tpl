...
<div class="frame_wrap frame_wrap_content">
    {if isset($confirmation)}
        ...
        <ul class="footer_links clearfix">
            <li>
                <a class="btn button button-small" href="{$base_dir}">
                    <span>
    ...
    {else}
        ...
        <form action="{$request_uri|escape:'html':'UTF-8'}" method="post" class="contact-form-box" enctype="multipart/form-data">
            <fieldset>
                ...
                <div class="clearfix">
                    <div class="col-xs-12 col-md-3">
                        <div class="form-group selector1">
                            ...
                            {foreach from=$contacts item=contact}
                                <p id="desc_contact{$contact.id_contact|intval}" class="desc_contact contact-title alert alert-info" style="display:none;">
                ...
                <div class="submit">
                    <button type="submit" name="submitMessage" id="submitMessage" class="btn btn-primary exclusive no-border-radius"><span>{l s='Send'}</span></button>
                </div>
            </fieldset>
        </form>
    {/if}
