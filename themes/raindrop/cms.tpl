    ...
    {if !$cms->active}
        ...
        <div id="admin-action-cms">
            <p>
                ...
                <input type="submit" value="{l s='Publish'}" name="publish_button" class="button btn"/>
                <input type="submit" value="{l s='Back'}" name="lnk_view" class="button btn"/>
            </p>
            <div class="clear" ></div>
...
<div class="rte{if $content_only} content_only{/if}">
    <div class="frame_wrap frame_wrap_header clearfix">
        <div class="fwh-title">{$cms->meta_title}</div>
    </div>
...
{elseif isset($cms_category)}
    <div class="block-cms frame_wrap">
