...
<div class="breadcrumb clearfix {if !$hide_left_column && isset($vertical_menu_fixed) && $vertical_menu_fixed} col-sm-offset-3{/if}">
    <a class="home" href="{$base_dir}" title="{l s='Return to Home'}">Home</a>
